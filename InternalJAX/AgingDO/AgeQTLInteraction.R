...
library(biomaRt)
library(shiny)
load("/projects/ytakemon/AgingDO/QTL/shiny_annotation.RData")
load("/projects/ytakemon/AgingDO/QTL/DO188b_kidney.RData")
...
ui <- fluidPage(
  ...
  # Title
  tags$h2(tags$a("Aging DO", href = "http://ctshiny01:3838/ytakemon/AgingDO/")," – Age * QTL Interaction"),
...
server <- function(input, output) {
  ...
  AgeQTLIntPlot <- function(){
    ...
    if (level_select == "mRNA"){
      ...
      file <- paste0("/projects/ytakemon/AgingDO/QTL/Intscan_mrna/Age/",
                     id,
                     "_",
                     symbol,
                     ".rds")
      ...
      symbol <- query$symbol[1]
      file <- paste0("/projects/ytakemon/AgingDO/QTL/Intscan_prot/Age/",
                     id,
                     "_",
                     symbol,
                     ".rds")
